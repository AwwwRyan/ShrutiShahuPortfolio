...
function TopProgressBar() {
  return (
    ...
    >
      <div className="h-full w-1/3 animate-[progress-slide_1.1s_ease-in-out_infinite] rounded-full bg-gradient-to-r from-teal via-navy-teal to-olive-sage motion-reduce:hidden" />
    </div>
  );
}
